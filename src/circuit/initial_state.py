...
# def get_real_denmat(num_qubits: int, prob_real: list[float], input_states: list[pnp.ndarray]) -> pnp.ndarray:
...
#     """
#     if not input_states:
#         return pnp.zeros((2**num_qubits, 2**num_qubits), dtype=complex)

#     density_matrix = pnp.zeros((2**num_qubits, 2**num_qubits), dtype=complex)
